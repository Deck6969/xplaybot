        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/xplay_discussion"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/xplay_main")
                        ],
                        [
    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            if message.from_user.id in Config.BANNED_USERS:
                await message.reply_text("ꜱᴏʀʀʏ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ!\n\nContact [Support Group](https://t.me/xplay_discussion)",
                                        disable_web_page_preview=True)
                return
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/xplay_discussion"),
                            InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/xplay_main")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
